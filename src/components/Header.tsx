...
const Header: React.FC<HeaderProps> = ({ serialNumber, resetSession }) => {
  return (
    <header
    ...
    >
      <div className="flex items-center space-x-3">
        {/* Reckon Icon */}
        <div className="w-8 h-8 bg-[#E5292F] rounded-[8px] flex items-center justify-center p-1.5 shadow-sm">
